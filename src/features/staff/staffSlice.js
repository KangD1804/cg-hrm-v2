...
import {createStaff, deleteStaff, findStaff, findStaffs, updateStaff} from "../../api/staffAPI";
...
export const getStaffs = createAsyncThunk("state/list", async () => {
    const response = await findStaffs();
    return response.data;
});

export const getStaff = createAsyncThunk("state/detail", async (staffId) => {
    const response = await findStaff(staffId);
    return response.data;
});

export const addStaff = createAsyncThunk("state/create", async (staff) => {
    const response = await createStaff(staff);
    return response.data;
});

export const editStaff = createAsyncThunk("state/edit", async (staff) => {
    const response = await updateStaff(staff);
    return response.data;
});

export const removeStaff = createAsyncThunk("state/remove", async (staffId) => {
...
export const staffSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            //Update states of get state action
            ...
            //Update states of add state action
            ...
            //Update states of edit state action
            ...
            //Update states of remove state action
...
//Enhancement feature of state slice
